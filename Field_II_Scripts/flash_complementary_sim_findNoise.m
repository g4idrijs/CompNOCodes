% Collect data where this is no phantom and report the standard 
% deviation of the resulting noisy image
...
codes{1}.focus = [0 0 70/1000]; % Focus in middle of collected area
...
% Set maximum and minimum imaging distances for just imaging noise
Rmax = 80/1000; Rmin = 60/1000;
