...
hTx = sin(2*pi/(lenImpResp)*(0:lenImpResp));
...
subplot(1,2,2)
plot((1:numel(rcvIn)) - 1,rcvIn,'o')
title(sprintf('Transducer Input \n Impulse Response: Single Cycle Sine Wave'))
xlabel('Time')
ylabel('Magnitude')
